...
public class Player extends Sprite implements Commons {
	...
	public Player(int initX, int initY, String name, int hearts, boolean isComputer, int difficulty, boolean isTop) {
		...
		if (name.equals(PLAYER)) {
			ImageIcon ii = new ImageIcon(getClass().getClassLoader().getResource("images/player1.png"));
			image = ii.getImage();

			// punching image
			ii = new ImageIcon(getClass().getClassLoader().getResource("images/player1_kick.png"));
			punchingImage = ii.getImage();

			// jumping image
			ii = new ImageIcon(getClass().getClassLoader().getResource("images/player1_jump.png"));
			jumpingImage = ii.getImage();

			// dead image
			ii = new ImageIcon(getClass().getClassLoader().getResource("images/player1_dead.png"));
			deadImage = ii.getImage();

			// with shield image
			ii = new ImageIcon(getClass().getClassLoader().getResource("images/player1_shield.png"));
			withShieldImage = ii.getImage();
		} else if (name.equals(OPPONENT)) {
			ImageIcon ii = new ImageIcon(getClass().getClassLoader().getResource("images/player2.png"));
			image = ii.getImage();

			// punching image
			ii = new ImageIcon(getClass().getClassLoader().getResource("images/player2_kick.png"));
			punchingImage = ii.getImage();

			// jumping image
			ii = new ImageIcon(getClass().getClassLoader().getResource("images/player2_jump.png"));
			jumpingImage = ii.getImage();

			// dead image
			ii = new ImageIcon(getClass().getClassLoader().getResource("images/player2_dead.png"));
			deadImage = ii.getImage();

			// with shield image
			ii = new ImageIcon(getClass().getClassLoader().getResource("images/player2_shield.png"));
			withShieldImage = ii.getImage();
		}
